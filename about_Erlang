...
The name Erlang, has been presumed by those working on the telephony switches to be a reference to Danish mathematician.Engineer Agner Krarup Erlang and a syllabic abbreviation of "Ericsson Language".
...
-Fault-tolerant
-Soft real-time
-Highly avalilable,non-stop applications
-Hot swapping,where code can be changed without stopping a system.
The Erlang programming language has immutable data,pattern matching,and functional programming.The sequentialsubset of the Erlang language supports eager evaluation,sigle assignment,and dynamic typing.
It was originally proprietary software within Ericsson, developed by Joe Armstrong, Robert Virding, and Mike Williams in 1986,but was released as free and open-source sotware n 1998.Erlang/OTP is supported and maintained by the Open Telecom Platform(OTP) product unit at Ericsson.
...
According to Armstrong, the language went from lab product to real applications following the collapse of the next-generation AXE telephone exchange named AXE-N in 1995.
As a result, Erlang was chosen for the next asynchronous transfer mode (ATM) exchange AXD.
...
The ban caused Armstrong and others to leave Ericsson.The implementation was open-sourced at the end of the year.Ericsson eventually lifted the ban and re-hired Armstrong in 2004.
